...
# KDE
```
sudo dnf install fcitx5 fcitx5-gtk fcitx5-qt fcitx5-unikey fcitx5-configtools qemu virt-manager dnsmasq vde2 dmidecode swtpm android-tools default-fonts-cjk btop vim kalk nethogs lm_sensors steam mangohud clang thunderbird seafile-client jetbrains-mono-fonts-all ibm-plex-fonts-all --skip-unavailable && sudo dnf remove mediawriter nano kcalc kaddressbook kleopatra kmahjongg kmail kmines kmouth kontact korganizer ktnef libreoffice* akregator neochat -y && sudo dnf in vim-default-editor -y
```
